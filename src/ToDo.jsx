...
function ToDo() {
  ...
  const [tasks, setTasks] = useState([
    { id: 1, text: "Research visa requirements", completed: false, weight: 10 },
    { id: 2, text: "Acquire all relevant visa documents", completed: false, weight: 10 },
    { id: 3, text: "Get visa pre-approval letter", completed: false, weight: 10 },
    { id: 4, text: "Tune resume and Linked in for NZ job market", completed: false, weight: 15 },
    { id: 5, text: "Start applying for jobs", completed: false, weight: 20 },
    { id: 6, text: "Snag job!", completed: false, weight: 100 },
    { id: 7, text: "Clear out U.S. house for sale", completed: false, weight: 40 },
    ...
    { id: 11, text: "Research Kiwi Culture", completed: false, weight: 15 },
    { id: 12, text: "Learn Kiwi Slang", completed: false, weight: 10 },
    { id: 13, text: "Hype Ellie and Maya for move", completed: false, weight: 30 },
    { id: 14, text: "Check shipping costs for belongings", completed: false, weight: 10 },
    { id: 15, text: "Research cities and communities", completed: false, weight: 15 },
    { id: 16, text: "Set up bank account in NZ", completed: false, weight: 10 },
    { id: 17, text: "Look into healthcare options", completed: false, weight: 10 },
    { id: 18, text: "Research schools for the kids", completed: false, weight: 10 },
    { id: 19, text: "Find pet transport services", completed: false, weight: 5 },
